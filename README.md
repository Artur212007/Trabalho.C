...
3. Entrar na pasta do projeto
   ...
   bash:
   cd Trabalho.C\src\Projeto\Model\teste-conexao
...
1. No terminal na pasta do projeto "teste-conexao", execute:

   bash:
   node server.js

 5. 🌐 Acessando o Sistema
1. vá até o Visual Studio Code, dentro da pasta Model no vscode abra o terminal que tem dentro do programa e digite npm run dev
2.Após isso clique no link criado 
