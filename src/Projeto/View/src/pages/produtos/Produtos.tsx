...
import { IconArrowLeft, IconBox, IconAlertTriangle, IconDollarSign, IconFactory, IconClock } from "../../components/icons";
import "./Produtos.css";
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        const msg = data.error || "Erro ao excluir produto.";
        if (msg.includes("venda")) {
          throw new Error("Este produto possui vendas vinculadas e não pode ser excluído. Cancele a(s) venda(s) primeiro.");
        }
        throw new Error(msg);
      }
    ...
    <div className="produtos-wrapper">
      ...
      <div className="produtos-page">
        <header className="p-topbar">
          <button className="btn-back" onClick={() => navigate("/dashboard")} title="Voltar">
        ...
        <div className="p-content">
          <div className="stats-row">
            ...
            <div className="stat-card"><div className="stat-icon si-red"><IconAlertTriangle /></div><div className="stat-info"><p>Estoque Crítico</p><strong>{stats.criticos}</strong></div></div>
            <div className="stat-card"><div className="stat-icon si-green"><IconDollarSign /></div><div className="stat-info"><p>Valor em Estoque</p><strong>{fmt(stats.valor)}</strong></div></div>
            <div className="stat-card"><div className="stat-icon si-blue"><IconFactory /></div><div className="stat-info"><p>Fornecedores</p><strong>{stats.fornecedores}</strong></div></div>
          </div>
          ...
          <div className="table-card">
            ...
            {loading ? (
              <div className="empty-state"><div className="big-icon"><IconClock /></div><p>Carregando produtos...</p></div>
            ) : lista.length === 0 ? (
              <div className="empty-state">
                <div className="big-icon"><IconBox /></div>
