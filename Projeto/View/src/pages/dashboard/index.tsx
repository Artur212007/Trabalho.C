      ...
      <main className="dashboard-content">
        ...
        <div className="dashboard-body">
          ...
          <div className="dashboard-grid">
            ...
            <div className="panel">
              <div className="panel-header">
                ...
                {dados && dados.atividade_recente.length > 0 && (
              ...
              <div className="panel-body">
                ...
                {!carregando && (!dados || dados.atividade_recente.length === 0) && (
                ...
                {!carregando && dados && dados.atividade_recente.map((v) => (
            ...
            <div className="panel">
              ...
              <div className="quick-access">
                {[
                  { icon:"👤", label:"Novo Cliente",        sub:"Cadastrar cliente",    to:"/clientes" },
                  { icon:"📋", label:"Nova Ordem",          sub:"Criar O.S.",            to:"/ordens" },
                  { icon:"📦", label:"Gerenciar Produtos",  sub:"Estoque e preços",      to:"/produtos" },
                  { icon:"💳", label:"Fluxo de Caixa",      sub:"Receitas e despesas",   to:"/caixa" },
                  { icon:"👥", label:"Usuários",            sub:"Gerenciar acessos",     to:"/usuarios" },
                ].map((q, i) => (
          ...
          <div className="logout-section">
            ...
            <Link to="/" className="btn-logout-full">
